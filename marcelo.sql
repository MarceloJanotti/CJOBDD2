...
-- Nome do aluno: Marcelo de Alcantara Janotti
...
CREATE DATABASE LOJAMARIACJ3019675;
GO


-- Habilita o contexto do banco de dados
USE LOJAMARIACJ3019675;
GO
...
CREATE TABLE CLIENTESCJ3019675 (
...
CREATE TABLE VENDEDORESCJ3019675 (
...
CREATE TABLE PEDIDOSCJ3019675 (
    ...
    FOREIGN KEY (CodigoCliente)  REFERENCES CLIENTESCJ3019675 (CodigoCliente),
    FOREIGN KEY (CodigoVendedor) REFERENCES VENDEDORESCJ3019675 (CodigoVendedor)
);
GO


-- Cria a tabela PRODUTOS
CREATE TABLE PRODUTOSCJ3019675 (
...
CREATE TABLE ITEM_DE_PEDIDOCJ3019675 (
    NumeroPedido  INT NOT NULL,
    CodigoProduto SMALLINT NOT NULL,
    Quantidade    INT,
    PRIMARY KEY (NumeroPedido, CodigoProduto),
    FOREIGN KEY (NumeroPedido)  REFERENCES PEDIDOSCJ3019675 (NumeroPedido),
    FOREIGN KEY (CodigoProduto) REFERENCES PRODUTOSCJ3019675 (CodigoProduto)
);
GO
...
--  Insere os clientes 
INSERT INTO CLIENTESCJ3019675 VALUES 
...
SELECT * FROM CLIENTESCJ3019675;
GO


--  Insere os vendedores
INSERT INTO VENDEDORESCJ3019675 VALUES 
    (209, 'José', 1800.00,'C'),
...
SELECT * FROM VENDEDORESCJ3019675;
GO


--  Insere os produtos
INSERT INTO PRODUTOSCJ3019675 VALUES 
    (25, 'Queijo','Kg', 0.97),
...
SELECT * FROM PRODUTOSCJ3019675;
GO


--  Insere os pedidos
INSERT INTO PEDIDOSCJ3019675 VALUES 
    (121, 20, 410, 209),
    (97, 20, 720, 101),
    (101, 15, 720, 101),
    (137, 20, 720, 720),
...
SELECT * FROM PEDIDOSCJ3019675;
GO


--  Insere os itens de pedido
INSERT INTO ITEM_DE_PEDIDOCJ3019675 VALUES 
    (121, 25, 10),
    (121, 31, 35),
    (97, 77, 20),
    (101, 31, 9),
...
SELECT * FROM ITEM_DE_PEDIDOCJ3019675;
GO
...
SELECT * FROM (
	SELECT
		*,
		(SELECT AVG(Salario) FROM VENDEDORESCJ3019675) AS Media_Salarial
	 FROM VENDEDORESCJ3019675
) AS Resultado
...
SELECT * FROM (
	SELECT
			...
			PE.PrazoEntrega,
			V.NomeVendedor
		FROM CLIENTESCJ3019675 C 
		INNER JOIN PEDIDOSCJ3019675 PE ON C.CodigoCliente = PE.CodigoCliente
		INNER JOIN ITEM_DE_PEDIDOCJ3019675 I ON PE.NumeroPedido =I.NumeroPedido
		INNER JOIN PRODUTOSCJ3019675 P ON I.CodigoProduto = P.CodigoProduto
		INNER JOIN VENDEDORESCJ3019675 V ON  PE.CodigoVendedor = V.CodigoVendedor
) AS Resultado
...
DROP DATABASE LOJAMARIACJ3019675;
GO
